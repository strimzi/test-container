...
/**
 * StrimziProducerContainer is a specialized container that wraps the Kafka console producer.
 * It allows you to configure and run the producer with various options in integration tests.
 */
