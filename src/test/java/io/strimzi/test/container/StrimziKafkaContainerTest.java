...
class StrimziKafkaContainerTest {
    ...
    void testBuildDefaultServerPropertiesWithKRaft() {
        ...
        assertThat(properties.getProperty("controller.listener.names"), is(Listener.CONTROLLER));
    }
    ...
    void testGetClientListenerProtocolWithPlaintext() {
        ...
        assertThat(kafkaContainer.getClientListenerProtocol(), is(Listener.PLAINTEXT));
    }
    ...
    void testGetClientListenerProtocolWithTlsOnly() {
        ...
        assertThat(kafkaContainer.getClientListenerProtocol(), is(Listener.SSL));
    }
    ...
    @Test
    void testConfigureTlsAddsControllerListenerWhenMissing() {
        CertAssembly certAssembly = CertAssembly.autoGenerated();
    ...
    @Test
    void testConfigureTlsDoesNotAddDuplicateControllerListener() {
        CertAssembly certAssembly = CertAssembly.autoGenerated();
